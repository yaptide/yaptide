...
$fastCmd = { docker compose --file docker-compose.yml --file docker-compose-develop.yml --file docker-compose.fast.yml up --detach }
...
if ($LASTEXITCODE -ne 0) {
  ...
  docker compose --file docker-compose.yml --file docker-compose-develop.yml up --detach
}
