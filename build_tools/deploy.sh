...
if [ "master" = $current_branch ]; then
    echo "{\"port\": \"5001\", \"dbName\": \"yaptide-db-master\", \"dbUsername\": \"master\", \"dbPassword\": \"password\", \"dbPort\": \"27017\"}" > $SCRIPT_PATH/../release/conf.json
    ...
    echo "{\"port\": \"5002\", \"dbName\": \"yaptide-db-develop\", \"dbUsername\": \"develop\", \"dbPassword\": \"password\", \"dbPort\": \"27017\"}" > $SCRIPT_PATH/../release/conf.json
    ...
    echo "{\"port\": \"5003\", \"dbName\": \"yaptide-db-staging\", \"dbUsername\": \"staging\", \"dbPassword\": \"password\", \"dbPort\": \"27017\"}" > $SCRIPT_PATH/../release/conf.json
